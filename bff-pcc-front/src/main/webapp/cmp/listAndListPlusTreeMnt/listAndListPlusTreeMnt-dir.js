...
app.directive("listAndListPlusTreeMnt", function () {
    return {
        restrict: 'AE'
        , replace: true
        , scope: {
        ...
        , templateUrl: 'cmp/listAndListPlusTreeMnt/listAndListPlusTreeMnt-tpl.html'
        , controller: function ($scope, BroadcastService) {
            console.log(">>>listAndListPlusTreeMnt scope=", $scope);
            var vm = $scope;
            ...
            vm._init()
            console.log("<<<listAndListPlusTreeMnt");
        }
    }
})
;