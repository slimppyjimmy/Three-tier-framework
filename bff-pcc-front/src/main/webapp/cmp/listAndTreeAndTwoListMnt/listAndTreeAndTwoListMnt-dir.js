...
app.directive("listAndTreeAndTwoListMnt", function () {
    return {
        restrict: 'AE'
        , replace: true
        , scope: {
        ...
        , templateUrl: 'cmp/listAndTreeAndTwoListMnt/listAndTreeAndTwoListMnt-tpl.html'
        , controller: function ($scope, BroadcastService,HttpService) {
            console.log(">>>listAndTreeAndTwoListMnt scope=", $scope);
            var vm = $scope;
            ...
            vm._init()
            console.log("<<<listAndTreeAndTwoListMnt");
        }
    }
})
;