...
app.directive("selectAndListAndThreeListMnt", function (BroadcastService) {
    return {
        restrict: 'AE'
        , replace: true
        , scope: {
        ...
        , templateUrl: 'cmp/selectAndListAndThreeListMnt/selectAndListAndThreeListMnt-tpl.html'
        , controller: function ($scope, BroadcastService) {
            console.log(">>>selectAndListAndThreeListMnt scope=", $scope);
            var vm = $scope;
            ...
            vm._init();
            console.log("<<<selectAndListAndThreeListMnt");
        }
    }
})
;