...
app.directive("selectAndTreeAndListMnt", function () {
    return {
        restrict: 'AE'
        , replace: true
        , scope: {
        ...
        , templateUrl: 'cmp/selectAndTreeAndListMnt/selectAndTreeAndListMnt-tpl.html'
        , controller: function ($scope, BroadcastService,HttpService) {
            console.log(">>>selectAndTreeAndListMnt scope=", $scope);
            var vm = $scope;
            ...
            vm._init()
            console.log("<<<selectAndTreeAndListMnt");
        }
    }
})
;