...
app.directive("treeAndTwoListMnt", function (BroadcastService) {
    return {
        restrict: 'AE'
        , replace: true
        , scope: {
        ...
        , templateUrl: 'cmp/treeAndTwoListMnt/treeAndTwoListMnt-tpl.html'
        , controller: function ($scope, BroadcastService) {
            console.log(">>>treeAndTwoListMnt scope=", $scope);
            var vm = $scope;
