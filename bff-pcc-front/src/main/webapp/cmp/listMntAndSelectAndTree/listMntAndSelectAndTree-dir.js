...
app.directive("listMntAndSelectAndTree", function () {
    return {
        restrict: 'AE'
        , replace: true
        , scope: {
        ...
        , templateUrl: 'cmp/listMntAndSelectAndTree/listMntAndSelectAndTree-tpl.html'
        , controller: function ($scope, BroadcastService,HttpService) {
            console.log(">>>listMntAndSelectAndTree scope=", $scope);
            var vm = $scope;
            ...
            vm._init()
            console.log("<<<listMntAndSelectAndTree");
        }
    }
})
;