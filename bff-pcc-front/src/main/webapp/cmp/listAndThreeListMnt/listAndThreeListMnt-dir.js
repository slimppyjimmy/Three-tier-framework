...
app.directive("listAndThreeListMnt", function (BroadcastService) {
    return {
        restrict: 'AE'
        , replace: true
        , scope: {
        ...
        , templateUrl: 'cmp/listAndThreeListMnt/listAndThreeListMnt-tpl.html'
        , controller: function ($scope, BroadcastService,HttpService) {
            console.log(">>>listAndThreeListMnt scope=", $scope);
            var vm = $scope;
            ...
            vm._init();
            console.log("<<<listAndThreeListMnt");
        }
    }
})
;