...
app.directive("twoListMnt", function (BroadcastService) {
    return {
        restrict: 'AE'
        , replace: true
        , scope: {
        ...
        , templateUrl: 'cmp/twoListMnt/twoListMnt-tpl.html'
        , controller: function ($scope, BroadcastService) {
            console.log(">>>twoListMnt scope=", $scope);
            var vm = $scope;
