...
app.directive("selectAndTreeAndTwoListMnt", function (BroadcastService) {
    return {
        restrict: 'AE'
        , replace: true
        , scope: {
        ...
        , templateUrl: 'cmp/selectAndTreeAndTwoListMnt/selectAndTreeAndTwoListMnt-tpl.html'
        , controller: function ($scope, BroadcastService, HttpService) {
            console.log(">>>selectAndTreeAndTwoListMnt scope=", $scope);
            var vm = $scope;
            ...
            vm._init();
            console.log("<<<selectAndTreeAndTwoListMnt");
        }
    }
})
;