...
app.directive("treeAndListMnt", function () {
    return {
        restrict: 'AE'
        , replace: true
        , scope: {
        ...
        , templateUrl: 'cmp/treeAndListMnt/treeAndListMnt-tpl.html'
        , controller: function ($scope, BroadcastService,HttpService) {
            console.log(">>>treeAndListMnt scope=", $scope);
            var vm = $scope;
