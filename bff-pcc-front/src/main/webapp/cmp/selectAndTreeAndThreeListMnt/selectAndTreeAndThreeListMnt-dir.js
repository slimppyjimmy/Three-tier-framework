...
app.directive("selectAndTreeAndThreeListMnt", function (BroadcastService) {
    return {
        restrict: 'AE'
        , replace: true
        , scope: {
        ...
        , templateUrl: 'cmp/selectAndTreeAndThreeListMnt/selectAndTreeAndThreeListMnt-tpl.html'
