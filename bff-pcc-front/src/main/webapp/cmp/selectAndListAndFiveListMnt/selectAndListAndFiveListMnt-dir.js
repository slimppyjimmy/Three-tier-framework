...
app.directive("selectAndListAndFiveListMnt", function (BroadcastService) {
    return {
        restrict: 'AE'
        , replace: true
        , scope: {
        ...
        , templateUrl: 'cmp/selectAndListAndFiveListMnt/selectAndListAndFiveListMnt-tpl.html'
        , controller: function ($scope, BroadcastService,HttpService) {
            console.log(">>>selectAndListAndFiveListMnt scope=", $scope);
            var vm = $scope;
            ...
            vm._initCollapse = function () {
                ...
                vm._collapseableControls.push(vm.param7);
            ...
            vm._init();
            console.log("<<<selectAndListAndFiveListMnt");
        }
    }
})
;