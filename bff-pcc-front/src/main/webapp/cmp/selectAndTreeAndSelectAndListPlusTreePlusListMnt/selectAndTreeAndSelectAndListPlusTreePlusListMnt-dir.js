...
app.directive("selectAndTreeAndSelectAndListPlusTreePlusListMnt", function (BroadcastService) {
    return {
        restrict: 'AE'
        , replace: true
        , scope: {
        ...
        , templateUrl: 'cmp/selectAndTreeAndSelectAndListPlusTreePlusListMnt/selectAndTreeAndSelectAndListPlusTreePlusListMnt-tpl.html'
        , controller: function ($scope, BroadcastService,HttpService) {
            console.log(">>>selectAndTreeAndThreeListMnt scope=", $scope);
            var vm = $scope;
            ...
            vm._init();
            console.log("<<<selectAndTreeAndThreeListMnt");
        }
    }
})
;