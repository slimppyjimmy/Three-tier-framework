...
app.directive("selectAndTreeAndListMntAndListMnt", function () {
    return {
        restrict: 'AE'
        , replace: true
        , scope: {
        ...
        , templateUrl: 'cmp/selectAndTreeAndListMntAndListMnt/selectAndTreeAndListMntAndListMnt-tpl.html'
        , controller: function ($scope, BroadcastService,HttpService) {
            console.log(">>>selectAndTreeAndListMntAndListMnt scope=", $scope);
            var vm = $scope;
            ...
            vm._init()
            console.log("<<<selectAndTreeAndListMntAndListMnt");
        }
    }
})
;