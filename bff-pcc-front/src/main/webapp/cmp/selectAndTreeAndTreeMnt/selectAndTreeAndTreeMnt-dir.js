...
app.directive("selectAndTreeAndTreeMnt", function () {
    return {
        restrict: 'AE'
        , replace: true
        , scope: {
        ...
        , templateUrl: 'cmp/selectAndTreeAndTreeMnt/selectAndTreeAndTreeMnt-tpl.html'
        , controller: function ($scope, BroadcastService) {
            console.log(">>>selectAndTreeAndTreeMnt scope=", $scope);
            var vm = $scope;
            ...
            vm._init()
            console.log("<<<selectAndTreeAndTreeMnt");
        }
    }
})
;