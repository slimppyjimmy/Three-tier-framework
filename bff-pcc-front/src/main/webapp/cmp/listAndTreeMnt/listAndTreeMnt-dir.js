...
app.directive("listAndTreeMnt", function () {
    return {
        restrict: 'AE'
        , replace: true
        , scope: {
        ...
        , templateUrl: 'cmp/listAndTreeMnt/listAndTreeMnt-tpl.html'
        , controller: function ($scope, BroadcastService,HttpService) {
            console.log(">>>listAndTreeMnt scope=", $scope);
            var vm = $scope;
