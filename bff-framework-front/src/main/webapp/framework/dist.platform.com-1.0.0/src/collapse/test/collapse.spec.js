describe('collapse directive', function () {
  ...
  beforeEach(module('dist.ui.collapse'));
  ...
  beforeEach(function() {
    element = $compile('<div wi-collapse="isCollapsed">Some Content</div>')(scope);
  ...
  describe('dynamic content', function() {
    ...
    beforeEach(function() {
      element = angular.element('<div wi-collapse="isCollapsed"><p>Initial content</p><div ng-show="exp">Additional content</div></div>');
