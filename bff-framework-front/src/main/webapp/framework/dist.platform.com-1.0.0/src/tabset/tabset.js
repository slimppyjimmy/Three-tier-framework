 ...
 */
    .directive('wiTabset', ['wiResizeListener','wiCommonSev', '$timeout', 'tabsetConf',function(wiResizeListener,wiCommonSev,$timeout, tabsetConf) {
        return {
            ...
            templateUrl: 'framework/dist.platform.com-1.0.0/src/tebset/template/tebset/tabsetTemplate.html',
 ...
 */
    .directive('wiTab', ['$parse','wiCommonSev', function($parse,wiCommonSev) {
        return {
            ...
            restrict: 'E',
            replace: true,
            templateUrl: 'framework/dist.platform.com-1.0.0/src/tebset/template/tebset/tabTemplate.html',
            transclude: true,
            scope: {
                heading: '@'
            },
