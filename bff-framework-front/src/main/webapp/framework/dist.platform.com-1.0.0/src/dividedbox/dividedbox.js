        ...
        return{
            dividedboxProductor: function (type) {
                ...
                return {
                    ...
                    templateUrl: function () {
                        return  'framework/dist.platform.com-1.0.0/src/dividedbox/template/dividedbox/wi-dividedbox.html';
                    },
                    transclude: true,
                    replace: true,
                    scope: {},
            ...
            dividedboxGroupProductor: function (type) {
                ...
                return {
                    restrict: 'E',
                    templateUrl: function () {
                        return  'framework/dist.platform.com-1.0.0/src/dividedbox/template/dividedbox/wi-dividedbox-group.html';
                    },
                    transclude: true,
                    replace: true,
                    scope: {},
