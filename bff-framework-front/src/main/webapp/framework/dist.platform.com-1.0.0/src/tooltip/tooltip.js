...
angular.module('dist.ui.tooltip', [ 'dist.ui.position', 'dist.ui.bindHtml' ])
    ...
    .directive('tooltipPopup', function () {
        return {
            ...
            templateUrl: 'framework/dist.platform.com-1.0.0/src/tooltip/template/tooltip/tooltip-popup.html',
 ...
 */
    ...
    .directive('tooltipHtmlUnsafePopup', function () {
        return {
            ...
            replace: true,
            scope: { content: '@', placement: '@', animation: '&', isOpen: '&' },
            templateUrl: 'framework/dist.platform.com-1.0.0/src/tooltip/template/tooltip/tooltip-html-unsafe-popup.html',
            link: function(scope, elem){
                elem.on('$destroy', function(){
                    scope.$destroy();
                });
