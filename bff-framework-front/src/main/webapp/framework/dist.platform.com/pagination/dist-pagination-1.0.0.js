/**
 * Created by wanggb on 2016/7/26.
 */

/*对外module接口：dist.com*/
angular.module('dist.ui.pagination',['dist.com.tpls', 'dist.paging','dist.tabindex','dist.pagination']);
angular.module('dist.com.tpls',['uib/template/pagination/pagination.html'])
angular.module('dist.paging', [])
    /**
...
angular.module('dist.pagination', ['dist.paging', 'dist.tabindex'])
    .controller('DistPaginationController', ['$scope', '$attrs', '$parse', 'distPaging', 'distPaginationConfig', function($scope, $attrs, $parse, distPaging, distPaginationConfig) {
        var ctrl = this;
    ...
    .directive('distPagination', ['$parse', 'distPaginationConfig', function($parse, distPaginationConfig) {
        return {
            scope: {
                totalItems: '=',
                firstText: '@',
            ...
            require: ['distPagination', '?ngModel'],
            restrict: 'A',
            controller: 'DistPaginationController',
