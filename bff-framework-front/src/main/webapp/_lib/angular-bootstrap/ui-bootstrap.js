 ...
 */
  ...
  function($animateCss, $injector, $modalStack) {
    return {
      replace: true,
      templateUrl: 'pcc/uib/template/modal/backdrop.html',
      compile: function(tElement, tAttrs) {
...
.directive('uibTooltipPopup', function() {
  return {
    ...
    templateUrl: 'pcc/uib/template/tooltip/tooltip-popup.html'
  };
})
...
.directive('uibTooltipTemplatePopup', function() {
  return {
    ...
    scope: { contentExp: '&', placement: '@', popupClass: '@', animation: '&', isOpen: '&',
      originScope: '&' },
    templateUrl: 'pcc/uib/template/tooltip/tooltip-template-popup.html'
  };
})
...
.directive('uibTooltipHtmlPopup', function() {
  return {
    replace: true,
    scope: { contentExp: '&', placement: '@', popupClass: '@', animation: '&', isOpen: '&' },
    templateUrl: 'pcc/uib/template/tooltip/tooltip-html-popup.html'
  };
})
...
.directive('uibPopoverTemplatePopup', function() {
  return {
    ...
    scope: { title: '@', contentExp: '&', placement: '@', popupClass: '@', animation: '&', isOpen: '&',
      originScope: '&' },
    templateUrl: 'pcc/uib/template/popover/popover-template.html'
  };
})
...
.directive('uibPopoverHtmlPopup', function() {
  return {
    ...
    templateUrl: 'pcc/uib/template/popover/popover-html.html'
  };
})
...
.directive('uibPopoverPopup', function() {
  return {
    ...
    templateUrl: 'pcc/uib/template/popover/popover.html'
  };
})
...
.directive('uibProgress', function() {
  return {
    ...
    templateUrl: 'pcc/uib/template/progressbar/progress.html'
  };
})
...
.directive('uibBar', function() {
  return {
    ...
    templateUrl: 'pcc/uib/template/progressbar/bar.html',
...
.directive('uibProgressbar', function() {
  return {
    ...
    templateUrl: 'pcc/uib/template/progressbar/progressbar.html',
    link: function(scope, element, attrs, progressCtrl) {
...
.directive('uibRating', function() {
  return {
    ...
    templateUrl: 'pcc/uib/template/rating/rating.html',
    replace: true,
    link: function(scope, element, attrs, ctrls) {
...
.directive('uibTabset', function() {
  return {
    ...
    templateUrl: 'pcc/uib/template/tabs/tabset.html',
    link: function(scope, element, attrs) {
...
.directive('uibTab', ['$parse', function($parse) {
  return {
    require: '^uibTabset',
    replace: true,
    templateUrl: 'pcc/uib/template/tabs/tab.html',
    transclude: true,
    scope: {
      active: '=?',
      heading: '@',
...
.constant('uibTimepickerConfig', {
  ...
  arrowkeys: true,
  showSpinners: true,
  templateUrl: 'pcc/uib/template/timepicker/timepicker.html'
})
